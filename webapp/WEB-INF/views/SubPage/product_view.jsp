				...
				<div class="productView_content">
					<dl>
						...
						<dd class="productView_content_dd_01">
							<ul class="productView_content_ul" style="margin-bottom: 60px;">
					...
					<div>
						<p>포인트&nbsp;<em id="popo">${authUser.point }</em>점</p>
	...
	$("#btn2").on("click", function(){
		...
		if(point> product_price){
			$.ajax({
				...
				type: "POST",
				data: {"product_price":product_price, "product_no":product_no, "store_no":store_no },
				dataType: "text",
				success: function(result){
					console.log('success');
					if(result == "1"){
						alert('구매하신 상품은 이메일로 보내드렸습니다. 매장에서 사용해주세요. 감사합니다.');
						/* sweetAlert("찜해제!"); */
						$("#popo").html('${authUser.point - prodvo.price }');
					} else{
